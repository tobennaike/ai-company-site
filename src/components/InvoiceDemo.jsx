      ...
      <div className="container">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            {/* Browser chrome */}
            <div className="rounded-2xl border border-gray-200 shadow-2xl shadow-black/10 bg-white overflow-hidden relative">
              {/* Top bar */}
              ...
              <div className="p-5 h-[380px] flex flex-col overflow-hidden">
                  ...
                  {phase === 0 ? (
                    ...
                    <div className="flex flex-col items-center gap-4">
                      <div className="flex gap-1.5">
                        {[0, 1, 2].map((i) => (
                          <span key={i} className="w-2 h-2 rounded-full bg-gray-400 animate-pulse" style={{ animationDelay: `${i * 200}ms` }} />
                        ))}
                      </div>
                ...
                <div className={`flex-1 flex flex-col gap-3 transition-opacity duration-300 ${
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={`ml-auto text-xs font-medium text-emerald-600 bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded-full transition-opacity duration-300 ${
