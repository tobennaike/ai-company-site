      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto px-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-sm sm:max-w-none mx-auto">
            ...
            <a
              href="#services"
              className="inline-flex items-center justify-center text-sm font-medium h-12 px-8 rounded-full text-gray-600 hover:text-gray-900 transition-all duration-300"
            >
              Our Services
            </a>
          </div>
