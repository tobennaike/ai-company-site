  ...
  return (
    <footer className="py-12">
      <div className="container">
        <hr className="border-[hsl(var(--border))] mb-12" />
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-8 mb-12">
        ...
        <div className="max-w-4xl mx-auto text-center text-sm text-[hsl(var(--muted-foreground))]">
